...
dur_pth = "/home/ubuntu/xsy/experiment/serverless/code-start/azure-data/function_durations_percentiles.anon.d01.csv"

invoc_pth = "/home/ubuntu/xsy/experiment/serverless/code-start/azure-data/invocations_per_function_md.anon.d01.csv"
buckets = [str(i) for i in range(1, 1441)]
columns = ["HashOwner","HashApp","HashFunction","Trigger"] + buckets

mem_pth = "/home/ubuntu/xsy/experiment/serverless/code-start/azure-data/app_memory_percentiles.anon.d01.csv"
...
ax1.hist2d(x=joined["sums"], y=joined["divvied"], bins=100, density=True, cmap='plasma')
...
ax1.hist2d(x=joined["Average"], y=joined["divvied"], bins=100, density=True, cmap='plasma')
ax1.set_ylim((0,200))
